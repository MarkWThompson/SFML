...
INTERACTIVE OBJECTS
-------------------
Currently only spawn points have been implemented.
To create a spawn point, drag the desired texture onto Foreground layer then give it a custom property named "SpawnPoint" with a Boolean value type. Set this to true and you should be good to go!
